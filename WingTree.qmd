...
*click and drag to move map; click markers to view info*

::: {.column-page-inset-right}

![](birthplaces_map.html){width="900" height="800"}
...
![](age_at_death.html){width="900" height="800"}
...
tp <- ggplot(men,aes(label2=Age,label3=Birthplace,label4=Birth_Year,label5=Death_Year)) +
  ...
  geom_text(data = men,
            ...
            color = "#585c45",size=2) +theme_bw() + ylab("Generation") + scale_y_discrete(breaks=c(seq(1:12)))
